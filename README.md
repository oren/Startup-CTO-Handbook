...
Subject: agree on vision for engineering org.

Meeting objectives:
* Agree and document the vision for our engineering organization.

Meeting Agenda:
* 10 minutes: Oren share his vision (existing wiki page).
* 10 minutes: Lon share his vision (existing wiki page).
* 10 minutes: agree and document a shared vision (new wiki page)
* 15 minutes: [3W - what, so what, now what?](https://www.liberatingstructures.com/9-what-so-what-now-what-w/)
